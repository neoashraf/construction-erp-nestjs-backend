...
export enum DomainErrorCode {
  ...
  PAYABLE_NOT_SETTLEABLE = 'PAYABLE_NOT_SETTLEABLE',
  ALLOCATION_EXCEEDS_OUTSTANDING = 'ALLOCATION_EXCEEDS_OUTSTANDING',
  SETTLEMENT_ACCOUNT_IS_EXPENSE = 'SETTLEMENT_ACCOUNT_IS_EXPENSE',
  PAYMENT_ACCOUNT_NOT_CONFIGURED = 'PAYMENT_ACCOUNT_NOT_CONFIGURED',
  // purchase / PO / bill (PUR)
  NET_PAYABLE_NEGATIVE = 'NET_PAYABLE_NEGATIVE',
  LINE_TYPE_INVALID = 'LINE_TYPE_INVALID',
  PO_NOT_BILLABLE = 'PO_NOT_BILLABLE',
  INVALID_PO_TRANSITION = 'INVALID_PO_TRANSITION',
  PURCHASE_ACCOUNT_NOT_CONFIGURED = 'PURCHASE_ACCOUNT_NOT_CONFIGURED',
  // tenancy
